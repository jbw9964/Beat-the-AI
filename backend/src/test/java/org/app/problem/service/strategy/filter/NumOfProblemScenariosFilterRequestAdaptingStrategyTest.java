...
class NumOfProblemScenariosFilterRequestAdaptingStrategyTest {

    static final NumOfProblemScenariosFilterRequestAdaptingStrategy strategy
            = new NumOfProblemScenariosFilterRequestAdaptingStrategy();

    @Test
    @DisplayName("문제 플레이 횟수 필터링 요청은 from, to 속성만 받아들인다.")
    void testToFilter() {
    ...
    @Test
    @DisplayName("문제 플레이 횟수 필터링 요청 값은 1 보다 크거나 같아야 한다.")
