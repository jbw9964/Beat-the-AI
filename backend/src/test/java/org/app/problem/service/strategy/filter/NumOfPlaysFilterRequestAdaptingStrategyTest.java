...
class NumOfPlaysFilterRequestAdaptingStrategyTest {

    static final NumOfPlaysFilterRequestAdaptingStrategy strategy
            = new NumOfPlaysFilterRequestAdaptingStrategy();
