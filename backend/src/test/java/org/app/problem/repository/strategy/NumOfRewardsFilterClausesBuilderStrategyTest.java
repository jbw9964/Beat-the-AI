...
@Slf4j
@Import(NumOfRewardsFilterClausesBuilderStrategyTest.DataInitFacade.class)
@SuppressWarnings("SpringJavaInjectionPointsAutowiringInspection")
class NumOfRewardsFilterClausesBuilderStrategyTest extends IntegrationTestSupport {

    @Autowired
    NumOfRewardsFilterClausesBuilderStrategy strategy;
    ...
    @Test
    @DisplayName("두 보상 개수 사이 생성된 문제를 검색할 수 있다.")
    ...
    @Test
    @DisplayName("어느 보상 개수 기준 생성된 문제를 검색할 수 있다.")
